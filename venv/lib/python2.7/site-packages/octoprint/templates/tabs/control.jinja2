...
<div class="jog-panel" style="display: none;" data-bind="visible: loginState.isUser">
    <h1>Extruder 1</h1>
    <div>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendExtrudeCommand(1) }">{{ _('+') }}</button>
        <div class="input-append control-box">
            <input type="text" class="input-mini text-right" data-bind="value: extruder1Pressure, enable: isOperational() && !isPrinting() && loginState.isUser(), attr: {placeholder: settings.printer_defaultPressure}">
            <span class="add-on">psi</span>
        </div>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendRetractCommand(1) }">{{ _('-') }}</button>

        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendTempIncrease(1) }">{{ _('+') }}</button>
        <div class="input-append control-box">
            <input type="text" class="input-mini text-right" data-bind="value: extruder1Temp, enable: isOperational() && !isPrinting() && loginState.isUser(), attr: {placeholder: settings.printer_defaultTemperature}">
            <span class="add-on">° C</span>
        </div>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendTempDecrease(1) }">{{ _('-') }}</button>

        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendCustomCommand({type:'command',command:'M42 P16 S255'}) }">{{ _('Extrude') }}</button>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendCustomCommand({type:'command',command:'M42 P16 S0'}) }">{{ _('Stop') }}</button>
    </div>
</div>
<div class="jog-panel" style="display: none;" data-bind="visible: loginState.isUser">
    <h1>Extruder 2</h1>
    <div>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendExtrudeCommand(2) }">{{ _('+') }}</button>
        <div class="input-append control-box">
            <input type="text" class="input-mini text-right" data-bind="value: extruder2Pressure, enable: isOperational() && !isPrinting() && loginState.isUser(), attr: {placeholder: settings.printer_defaultPressure}">
            <span class="add-on">psi</span>
        </div>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendRetractCommand(2) }">{{ _('-') }}</button>

        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendTempIncrease(2) }">{{ _('+') }}</button>
        <div class="input-append control-box">
            <input type="text" class="input-mini text-right" data-bind="value: extruder2Temp, enable: isOperational() && !isPrinting() && loginState.isUser(), attr: {placeholder: settings.printer_defaultTemperature}">
            <span class="add-on">° C</span>
        </div>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendTempDecrease(2) }">{{ _('-') }}</button>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendCustomCommand({type:'command',command:'M42 P17 S255'}) }">{{ _('Extrude') }}</button>
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && !isPrinting() && loginState.isUser(), click: function() { $root.sendCustomCommand({type:'command',command:'M42 P17 S0'}) }">{{ _('Stop') }}</button>
    </div>
</div>
...
<div class="jog-panel" style="display: none;" data-bind="visible: loginState.isUser">
    ...
    <div>
        <!-- Light Intensity -->
        <input style="width: 100px" type="number" data-bind="slider: {min: 0, max: 100, step: 1, value: lightIntensity, tooltip: 'hide'}">
        <button class="btn btn-block control-box" data-bind="enable: isOperational() && loginState.isUser(), click: function() { $root.sendLightIntensity() }">{{ _('Light Intensity:') }}<span data-bind="text: lightIntensity() + '%'"></span></button>
