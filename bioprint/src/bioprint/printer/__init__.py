...
import bioprint.util.comm as comm
...
class PrinterInterface(object):
	"""
	The :class:`PrinterInterface` represents the developer interface to the :class:`~bioprint.printer.standard.Printer`
	instance.
	"""
	...
	def fake_ack(self):
		"""
		Fakes an acknowledgement for the communication layer. If the communication between bioprint and the printer
