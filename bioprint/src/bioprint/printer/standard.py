...
from bioprint import util as util
from bioprint.events import eventManager, Events
from bioprint.filemanager import FileDestinations
from bioprint.plugin import plugin_manager, ProgressPlugin
from bioprint.printer import PrinterInterface, PrinterCallback, UnknownScript
from bioprint.printer.estimation import TimeEstimationHelper
from bioprint.settings import settings
from bioprint.util import comm as comm
from bioprint.util import InvariantContainer
...
class Printer(PrinterInterface, comm.MachineComPrintCallback):
	...
	def set_wellplate(self, wellplate):
	...
	def get_current_connection(self):
		...
		if self._type is 'serial':
			...
			interface, channel = self._comm.getConnection()
			printer_profile = self._printerProfileManager.get_current_or_default()
			return self._comm.getStateString(), interface, channel, printer_profile
