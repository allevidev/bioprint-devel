$(function() {
    function PluginManagerViewModel(parameters) {
        ...
        self.repositoryplugins = new ItemListHelper(
            ...
            },
            {
                ...
                "filter_incompatible": function(plugin) {
                    return plugin.is_compatible.bioprint && plugin.is_compatible.os;
                }
            },
            "title",
        ...
        self.uploadElement.fileupload({
            ...
            fail: function(e, data) {
                new PNotify({
                    ...
                    text: gettext("Please consult bioprint.log for details"),
                    type: "error",
                    hide: false
                });
                self._markDone();
        ...
        self.isCompatible = function(data) {
            return data.is_compatible.bioprint && data.is_compatible.os;
        };
            ...
            if (messageType == "loglines" && self.working()) {
                ...
                if (action == "install") {
                    ...
                    if (unknown) {
                        ...
                        textSuccess = gettext("A plugin was installed successfully, however it was impossible to detect which one. Please Restart bioprint to make sure everything will be registered properly");
                        ...
                        textRestart = gettext("The plugin was reinstalled successfully, however a restart of bioprint is needed for that to take effect.");
                        ...
                        textRestart = gettext("The plugin was installed successfully, however a restart of bioprint is needed for that to take effect.");
                    ...
                    textRestart = gettext("The plugin was uninstalled successfully, however a restart of bioprint is needed for that to take effect.");
                    ...
                    textRestart = gettext("The plugin was enabled successfully, however a restart of bioprint is needed for that to take effect.");
                    ...
                    textRestart = gettext("The plugin was disabled successfully, however a restart of bioprint is needed for that to take effect.");
