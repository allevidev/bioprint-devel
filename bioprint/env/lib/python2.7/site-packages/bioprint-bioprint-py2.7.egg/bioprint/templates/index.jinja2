...
<html>
    <head>
        <title data-bind="text: title">BioPrint</title>
            ...
            <div class="container-fluid bioprint-container">
                ...
                <div class="footer">
                    <ul class="pull-left muted">
                        <li><small>Copyright BioBots Inc. 2015 </span></small></li>
                    </ul>
                    <ul class="pull-right">
                        <li><a href="http://biobots.io"><i class="icon-home"></i> {{ _('BioBiots Homepage') }}</a></li>
                    </ul>
                </div>
            </div>
